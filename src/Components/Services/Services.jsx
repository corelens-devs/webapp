...
const Services = () => {
  return (
    ...
    <div className={classes.service_div}>
        ...
        <ServiceComp heading={"24*7 Support and home services"} para={"Enjoy complementary HOME SERVICE for 2 years (rare now a days),free delivery pan india,72hour replacement policy , 24/7 toll-free call support and much more."} img={service3}/>
