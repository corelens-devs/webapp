...
const Services = () => {
  return (
    ...
    <div className={classes.service_div}>
        <ServiceComp para={"Forget old CCTV cameras and switch to our latest camera sensors. They come with alarms, mobile alerts, and human detection to help stop theft when you're away. You can even book surveillance for just 150 Rs per hour to watch your place while you're out."} heading={"Camera Sensors with On-Demand Surveillance"} img={service1}/>
