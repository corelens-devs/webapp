          ...
          try {
            ...
            const saveOrderResponse = await fetch(
              "https://backend.corelens.in/api/app/order",
              {
                ...
                headers: {
                  "Content-Type": "application/json",
                  Authorization: `Bearer ${paymentToken}`, // ✅ use same token as checkout
                },
            ...
            if (result.success) {
              await Swal.fire({
                icon: "success",
                title: "Order Saved!",
                text: "You can view your order in Purchase History.",
              ...
              await Swal.fire({
                icon: "warning",
                title: "Payment Verified, but Order Save Failed",
                text: "Please contact support if your payment was deducted.",
              });
            }
          } catch (err) {
            ...
            await Swal.fire({
              ...
              text: "Payment succeeded, but failed to save order!",
            });
          }
        },
